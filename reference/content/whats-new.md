...
- Refer to [What's New - Java Sync Documentation](https://www.mongodb.com/docs/drivers/java/sync/v4.6) for more information.

# What's new in 4.5

- Refer to [What's New - Java Sync Documentation](https://www.mongodb.com/docs/drivers/java/sync/v4.5) for more information.
...
It is _strongly recommended_ that system keep-alive settings should be configured with shorter timeouts.
